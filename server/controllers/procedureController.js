...
class ProcedureController {
    async create(req, res, next) {
        const { name, master_id, description, price, salon_id, category_id } = req.body;
        try {
            const procedure = await Procedure.create({ name, master_id, description, price, salon_id, category_id });
    ...
    async update(req, res, next) {
        ...
        try {
            ...
            procedure.name = name;
            procedure.master_id = master_id;
            procedure.description = description;
            procedure.price = price;
            procedure.salon_id = salon_id;
