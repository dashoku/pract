...
Procedure.belongsTo(Salon, { foreignKey: 'salon_id' });
Salon.hasMany(Procedure, { foreignKey: 'salon_id' });

Procedure.belongsTo(Master, { foreignKey: 'master_id' });
Master.hasMany(Procedure, { foreignKey: 'master_id' });
...
Master.hasMany(Record, { foreignKey: 'master_id' });
